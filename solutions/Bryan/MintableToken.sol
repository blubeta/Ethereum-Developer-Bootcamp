...
contract DankMemes is StandardToken, Ownable {
    ...
    function mint(uint256 tokensMinted, address _to) public returns (bool) {
        ...
        emit Transfer(this, _to, tokensMinted);
